...
const BOOK_ENTRY_TYPE_IDS = new Set([
    EntryType.INCOME.id, EntryType.INCOME_TAX.id, EntryType.INCOME_TAX_REFUND.id,
    EntryType.EXPENSE.id, EntryType.EXPENSE_REFUND.id, EntryType.LOAN_GIVEN.id,
    EntryType.LOAN_TAKEN.id, EntryType.INVESTMENT_DEPOSIT.id,
    EntryType.INVESTMENT_WITHDRAWAL.id, EntryType.POSITION_ONBOARD.id,
    EntryType.POSITION_OFFBOARD.id
]);

const entryTypeOptions = [
    EntryType.INCOME, EntryType.INCOME_TAX, EntryType.INCOME_TAX_REFUND,
    EntryType.EXPENSE, EntryType.EXPENSE_REFUND, EntryType.LOAN_GIVEN,
    EntryType.LOAN_TAKEN, EntryType.INVESTMENT_DEPOSIT, EntryType.INVESTMENT_WITHDRAWAL,
    EntryType.POSITION_ONBOARD, EntryType.POSITION_OFFBOARD,
    EntryType.RELOCATE, EntryType.PAYMENT, EntryType.RECEIPT, EntryType.TRANSFER
...
watch(() => addEntryState.visible, (newVal) => {
    if (newVal) resetForm();
});
...
function validate() {
    ...
    if (form.amount === null || form.amount === undefined || form.amount <= 0) return false;
...
<template>
    <Dialog
        v-model:visible="addEntryState.visible"
        modal
        header="Add Entry"
        :style="{ width: '32rem' }"
        ...
        <form @submit.prevent="handleSubmit" class="flex flex-col gap-4 pt-2">
            ...
            <div class="flex gap-4">
                ...
                <div class="flex flex-col gap-1 flex-1">
                    ...
                    <InputNumber
                        ...
                        :minFractionDigits="2"
                        :maxFractionDigits="2"
                        :invalid="submitted && (form.amount === null || form.amount <= 0)"
                        fluid
                    />
                    <small v-if="submitted && (form.amount === null || form.amount <= 0)" class="text-red-500">Required</small>
                </div>
            </div>
            ...
            <template v-if="isRelocate">
                <div class="flex flex-col gap-1">
                    ...
                    <Select
                        v-model="form.bookIdFrom"
                        :options="bookOptions"
                        optionLabel="label"
                        optionValue="value"
                        placeholder="Select source book"
                        :invalid="submitted && !form.bookIdFrom"
                        fluid
                    />
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <Select
                        v-model="form.bookIdTo"
                        :options="bookOptions"
                        optionLabel="label"
                        optionValue="value"
                        placeholder="Select destination book"
                        :invalid="submitted && !form.bookIdTo"
                        fluid
                    />
            ...
            <template v-if="isPayReceipt">
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <Select
                        ...
                        optionValue="value"
                        placeholder="Select source"
                        :invalid="submitted && !form.sourceId"
                        fluid
                    />
            ...
            <template v-if="isTransfer">
                <div class="flex flex-col gap-1">
                    ...
                    <Select
                        v-model="form.sourceIdFrom"
                        :options="sourceOptions"
                        optionLabel="label"
                        optionValue="value"
                        placeholder="Select source"
                        :invalid="submitted && !form.sourceIdFrom"
                        fluid
                    />
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <Select
                        v-model="form.sourceIdTo"
                        :options="sourceOptions"
                        optionLabel="label"
                        optionValue="value"
                        placeholder="Select destination source"
                        :invalid="submitted && !form.sourceIdTo"
                        fluid
                    />
